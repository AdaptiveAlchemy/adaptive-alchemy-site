---
title: 'AI Strategy for CEOs & Boards'
...
featureGrid:
  ...
  subheading: 'Strategic clarity across the dimensions that boards and investors care about.'
  items:
...
engagementTiers:
  heading: 'How we work with executive teams.'
  items:
    - eyebrow: 'Assessment'
      title: 'AI readiness and strategy assessment'
...
faq:
  ...
  - question: 'What are the biggest risks of adopting AI without a strategy?'
    answer: 'The three largest risks are wasted investment on AI experiments that never reach production, security and compliance exposure from ungoverned AI tool usage across the organization, and competitive disadvantage from falling behind while competitors operationalize AI. A strategy does not eliminate these risks but makes them visible and manageable with clear mitigations.'

ctaBand:
  headline: 'Get clarity on your AI strategy.'
  subheadline: '30-minute conversation with a senior strategist. We will discuss your competitive position, board expectations, and where AI fits into your strategic agenda.'
